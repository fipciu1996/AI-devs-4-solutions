...
from route_agent import (
    RailwayApiClient,
    RailwayError,
    extract_route_argument,
    extract_status_argument,
    require_route,
    require_status,
)
...
class ValidationTests(unittest.TestCase):
    ...
    def test_extract_route_argument_accepts_alias(self) -> None:
        self.assertEqual(extract_route_argument({"line": "B-4"}), "B-4")

    def test_extract_status_argument_accepts_alias(self) -> None:
        self.assertEqual(extract_status_argument({"status": "rtopen"}), "rtopen")
